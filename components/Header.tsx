            ...
            <nav className="bg-gradient-to-r from-orange-400 to-yellow-400">
                <div className="container mx-auto px-4">
                    <ul className="flex items-center">
                        {navItems.map((item) => (
                            <li key={item}>
                                <a href="#" className={`block px-4 py-2 text-white font-semibold text-sm transition-colors ${item === 'Bag Management' ? 'bg-red-600' : 'hover:bg-red-500'}`}>
                                    {item}
                                </a>
                            </li>
                        ))}
                         <li>
                            <a href="#" className="flex items-center px-4 py-2 text-white font-semibold text-sm hover:bg-red-500 transition-colors">
                                Others
